...
import { TrendingUp, Users, Briefcase, AlertCircle, Target, Sparkles } from 'lucide-react';
...
function Stat({ icon, label, value, tone = 'neutral' }: { icon: React.ReactNode; label: string; value: string; tone?: 'neutral' | 'violet' | 'amber' }) {
  const toneClass =
